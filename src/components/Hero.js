        ...
        <div class="bg-bgpic-img h-[680px] ">
            ...
            <div class="bg-[#cac7f3] border-[4px] border-[#7e0d8d] rounded-xl shadow-2xl shadow-slate-800 pb-[13px] pt-[35px]  ml-[200px] mr-[200px] ">
                <div class="flex justify-start items-center pb-28">
                    ...
                    <p class="w-[650px] text-center text-lg font-light  font-serif text-[#7e0d8d] italic pl-5">- Edgar Degas</p></div>
                </div> 
                <div class="flex justify-start items-center pb-28">
                    <hr class="w-[250px] bg-[#7e0d8d] h-1"/>
                    ...
                    <p class="w-[650px] text-center text-lg font-light  font-serif text-[#7e0d8d] italic pl-5">- Vincent Van Gogh</p></div>
                </div> 
                <div class="flex justify-start items-center pb-28">
                    <hr class="w-[250px] bg-[#7e0d8d] h-1"/>
                    ...
                    <p class="w-[650px] text-center text-lg font-light  font-serif text-[#7e0d8d] italic pl-5">- Pablo Picasso</p></div>
                </div> 
