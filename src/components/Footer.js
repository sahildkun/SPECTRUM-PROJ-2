...
function Footer() {
  ...
  <div class="container px-6 py-6 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p class="mt-2 text-xl text-white text-center">NEWSLETTER</p>
          ...
          <input type="text" id="footer-field" name="footer-field" placeholder="Enter your email" class="w-full bg-white rounded border border-white focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
      ...
      <div class="title-font font-medium text-white tracking-widest text-lg mb-5">GET IN TOUCH</div>
        <p class="flex items-center justify-center text-md md:justify-start mb-3 text-gray-400 hover:text-gray-600">
           <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
            class=" hidden md:block w-6 mr-4 " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 582 512">
  ...
  <div class="bg-slate-600">
    <div class="container mx-auto py-2 px-5 flex flex-wrap flex-col sm:flex-row">
      <p class="text-black text-md text-center sm:text-left py-1">© 2020 SpectraArtGallery</p>
      ...
      <p class="text-black text-xl text-center sm:text-right text-bold py-1">Get Connected : </p>
        <button class="hover:animate-bounce w-10 h-10 mx-2 inline-flex items-center justify-center rounded-lg bg-transparent flex-shrink-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z"/></svg>
          </button>
          <button class="hover:animate-bounce w-10 h-10 mr-2 inline-flex items-center justify-center rounded-lg bg-transparent flex-shrink-0">
          ...
          <button class="hover:animate-bounce w-10 h-10 inline-flex items-center justify-center rounded-lg bg-transparent flex-shrink-0">
